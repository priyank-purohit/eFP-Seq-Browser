...
def generate_rnaseq_graph(urlx, filename, out_clr):
	...
	#print "<br/><br/>urlx = " + "mpileups/"+urlx + "; out = " + filename + "<br/><br/>" # When reading from locally saved mpileups
	print "<br/><br/>urlx = " + urlx + "; out = " + filename + "<br/><br/>" # When reading from BAM files...
	if urlx == "":
		return
		...
		if child.attrib.get(key):
			...
			if key == "svgname":
				...
				if key == "name":
					...
					generate_rnaseq_graph((cases["img"]).replace(".png", ""), img_file_name, clr)
